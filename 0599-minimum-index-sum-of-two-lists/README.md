...
<pre style="position: relative;"><strong>Input:</strong> list1 = ["Shogun","Tapioca Express","Burger King","KFC"], list2 = ["Piatti","The Grill at Torrey Pines","Hungry Hunter Steakhouse","Shogun"]
...
<pre style="position: relative;"><strong>Input:</strong> list1 = ["Shogun","Tapioca Express","Burger King","KFC"], list2 = ["KFC","Shogun","Burger King"]
<strong>Output:</strong> ["Shogun"]
...
<pre style="position: relative;"><strong>Input:</strong> list1 = ["happy","sad","good"], list2 = ["sad","happy","good"]
