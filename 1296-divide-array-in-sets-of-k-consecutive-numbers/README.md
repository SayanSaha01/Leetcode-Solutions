...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,3,4,4,5,6], k = 4
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,2,1,2,3,4,3,4,5,9,10,11], k = 3
<strong>Output:</strong> true
