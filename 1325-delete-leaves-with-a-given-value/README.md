...
<pre style="position: relative;"><strong>Input:</strong> root = [1,2,3,2,null,2,4], target = 2
...
<pre style="position: relative;"><strong>Input:</strong> root = [1,3,3,3,2], target = 3
...
<pre style="position: relative;"><strong>Input:</strong> root = [1,2,null,2,null,2], target = 2
