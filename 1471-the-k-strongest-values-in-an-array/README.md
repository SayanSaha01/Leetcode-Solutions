...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3,4,5], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,1,3,5,5], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> arr = [6,7,11,7,6,8], k = 5
