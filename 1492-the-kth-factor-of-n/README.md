...
<pre style="position: relative;"><strong>Input:</strong> n = 12, k = 3
...
<pre style="position: relative;"><strong>Input:</strong> n = 7, k = 2
...
<pre style="position: relative;"><strong>Input:</strong> n = 4, k = 4
