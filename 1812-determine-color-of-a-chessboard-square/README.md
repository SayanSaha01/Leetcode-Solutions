...
<pre style="position: relative;"><strong>Input:</strong> coordinates = "a1"
...
<pre style="position: relative;"><strong>Input:</strong> coordinates = "h3"
...
<pre style="position: relative;"><strong>Input:</strong> coordinates = "c7"
<strong>Output:</strong> false
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
