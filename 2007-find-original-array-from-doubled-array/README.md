...
<pre style="position: relative;"><strong>Input:</strong> changed = [1,3,4,2,6,8]
...
<pre style="position: relative;"><strong>Input:</strong> changed = [6,3,0,1]
...
<pre style="position: relative;"><strong>Input:</strong> changed = [1]
<strong>Output:</strong> []
<strong>Explanation:</strong> changed is not a doubled array.
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
