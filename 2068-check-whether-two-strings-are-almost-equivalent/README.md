...
<pre style="position: relative;"><strong>Input:</strong> word1 = "aaaa", word2 = "bccb"
...
<pre style="position: relative;"><strong>Input:</strong> word1 = "abcdeef", word2 = "abaaacc"
...
<pre style="position: relative;"><strong>Input:</strong> word1 = "cccddabba", word2 = "babababab"
<strong>Output:</strong> true
<strong>Explanation:</strong> The differences between the frequencies of each letter in word1 and word2 are at most 3:
