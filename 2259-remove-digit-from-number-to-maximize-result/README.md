...
<pre style="position: relative;"><strong>Input:</strong> number = "123", digit = "3"
...
<pre style="position: relative;"><strong>Input:</strong> number = "1231", digit = "1"
...
<pre style="position: relative;"><strong>Input:</strong> number = "551", digit = "5"
