...
<pre style="position: relative;"><strong>Input:</strong> root = [6,2,13,1,4,9,15,null,null,null,null,null,null,14], queries = [2,5,16]
...
<pre style="position: relative;"><strong>Input:</strong> root = [4,null,9], queries = [3]
